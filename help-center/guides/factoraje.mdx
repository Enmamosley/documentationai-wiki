...
description: Cómo se canaliza una factura de proveedor a una empresa de factoraje en Embarque, paso a paso.
---
...
- El proveedor necesita liquidez antes del plazo de crédito que la empresa le otorga.
- Una empresa de factoraje ofrece pagar al proveedor más rápido a cambio de una comisión.
- La empresa prefiere mantener su propio plazo de pago largo y el proveedor cobrar pronto.
...
<Steps>
  ...
  <Step title="Configura comisiones" icon="percent">
    El sistema toma la comisión configurada en la empresa o el override negociado por proveedor. Verifica que el split (parte que absorbe el proveedor vs. la que retiene la empresa) sea el pactado.
  </Step>
...
<Steps>
  <Step title="El proveedor sube su factura" icon="upload">
    Desde el portal de proveedores, el proveedor sube el XML CFDI que emitió a la empresa.
  </Step>
  <Step title="El sistema valida el XML" icon="shield-check">
...
## Pago final a la empresa de factoraje

<Steps>
  <Step title="Cumplido el plazo" icon="calendar">
    Cuando se cumple el plazo de crédito hacia la empresa de factoraje (típicamente 60 días), la empresa le paga.
  </Step>
  ...
  <Step title="Ciclo cerrado" icon="check">
    El embarque queda completamente conciliado: cliente pagó, factoraje pagó al proveedor, la empresa pagó al factoraje.
  </Step>
</Steps>
