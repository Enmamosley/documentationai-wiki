...
<Steps>
  ...
  <Step title="Edita en el sistema">
    Si no puedes obtener un XML nuevo, edita los datos directamente en el sistema. Los cambios se guardan como **overrides** sobre el XML original sin alterarlo.
  </Step>
</Steps>
