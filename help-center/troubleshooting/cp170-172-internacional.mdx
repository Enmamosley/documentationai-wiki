...
<Tabs>
  <Tab title="Es nacional de verdad" icon="map-pin">
    Quita el pedimento del XML. Si el XML viene del proveedor, súbelo corregido. Como alternativa, marca **Carta Porte Propia** en el embarque para que el sistema genere el XML sin pedimento.
  </Tab>
...
Cuando el XML del proveedor es problemático y no puedes obtener uno corregido a tiempo, marca **Carta Porte Propia** en el embarque. Esto le dice al sistema que genere el XML directamente con los datos editables, ignorando el XML del proveedor.
...
<Steps>
  ...
  <Step title="Genera el XML">
    Al timbrar, el sistema construye el XML desde cero con los datos capturados, omitiendo el XML del proveedor.
  </Step>
</Steps>
